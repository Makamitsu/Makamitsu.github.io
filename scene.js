...
function Cam(){
    ...
    this.direction = vec3.create([0.0,1.0,0.0]);
    this.focal = 50.0;
    this.width = 36.0;

    this.rotationPhi = 0.0;
    ...
    this.rotationPhiLocation = gl.getUniformLocation(shaderProgram, "cam_rotationPhi");
    this.rotationThetaLocation = gl.getUniformLocation(shaderProgram, "cam_rotationTheta");
    this.updateUniform = function () {
        ...
        gl.uniform1f(this.rotationPhiLocation,this.rotationPhi);
        gl.uniform1f(this.rotationThetaLocation,this.rotationTheta);
    };
    this.updateUniform();
